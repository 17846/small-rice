...
require.config({
    paths:{
        ...
        top:"/public/js/totop",
        detail:"/public/js/detailShow",
        pos:"/public/js/position",
        shopping:"/public/js/shoppingCart"
    },
    shim:{
        //设置依赖关系
        cookie:["jquery"]
...
require(["slide","change","leftNa","login","out","topNav","search","top","detail","pos","shopping"],function(slide,chan,left,log,out,topNav,sea,top,detail,pos,shop){
