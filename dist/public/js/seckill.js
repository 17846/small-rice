...
require.config({
	paths:{
		...
		color:"/public/js/changcolor",
		time:"/public/js/sectime",
...
require(["slide","change","leftNa","login","out","topNav","search","color","time","shop"],function(slide,chan,left,log,out,topNav,sea,color,time,shop){
